 ...
 */
public class VoidSimpleTask extends AsyncTask<String, Void, Void> {
     ...
     */
    public VoidSimpleTask(String controller,VoidAsyncMethod voidAsyncMethod, List<SimpleParam> params) {
        if(params == null)
    ...
    public VoidSimpleTask(String controller, PostExecute postExecute) {
        if(params == null)
            params = new ArrayList<SimpleParam>();
    ...
    public VoidSimpleTask(String controller) {
        this.controller = controller;
        if(params == null)
            params = new ArrayList<SimpleParam>();
    }
